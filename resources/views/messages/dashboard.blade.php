...
<div id="frame">
	<div id="sidepanel">
        ...
        <?php $img = Auth::user()->profile_picture ?>
          @if ($img!=null)
          <img id="profile-img" src="{{asset('assets/uploads/profilepictures/'.$img)}}" alt="" />
          @else
          <img id="profile-img" src="https://i.stack.imgur.com/HQwHI.jpg" alt="" />
          @endif
...
<hr class="col-10">
        ...
        @foreach ($channels as $channel)
          <a href="/messages/{{$channel->id}}" style="color:white; text-decoration:none">
            <li class="contact">
              <div class="wrap">
                ...
                <div class="meta">
                  ...
                  @endif
                    <p class="preview">{{ \App\Message::where(['channel_id' => $channel->id])->pluck('message')->last() }}</p>
                </div>
              </div>
            </li>
          </a>
